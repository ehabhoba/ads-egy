  ...
  en: {
    ...
    coreServices: [
        ...
        { 
          ...
          path: "#/app/tool/video-display-system",
          desc: "Public and private video library, internal ads, and service samples with client video uploads.",
        ...
        { 
          icon: Mic, title: "AI Text-to-Speech (TTS)", slug: "ai-text-to-speech",
           path: "#/app/tool/ai-text-to-speech",
          desc: "Supports Arabic and Egyptian dialect, multiple voices, and tone customization for ads.",
    ...
    pricingPlans: [
        ...
        { name: "Professional", price: "499", popular: true, features: ["Everything in Free", "Advanced AI Tools", "Private E-commerce Store", "SEO Analytics & Reports", "Dedicated Tech Support"] },
